...
<html lang="en">
    ...
    <body id="page-top">
      ...
      <input type = "text" id="roomold" name="roomold">
...
<script language="javascript">
    ...
    .on('click','#update',function(){
       $.ajax({
         ...
         data:'roomname='+$('input[name=roomname]').val()+'&roomitem2='+$('#roomitem2 option:selected').text()+'&roomexpense='+$('input[name=roomexpense]').val()+'&person='+$('input[name=person]').val()+'&roomold='+$('input[name=roomold]').val(),
          dataType:'text',
          beforeSend:function(){},
    ...
    .on('click','#edit',function(){
    	...
    	$.ajax({
            ...
            data:'roomold='+$('input[name=roomold]').val()+'&roomitem2='+$('#roomitem2 option:selected').text()+'&roomexpense='+$('input[name=roomexpense]').val()+'&person='+$('input[name=person]').val()+'&roomname='+$('input[name=roomname]').val(),
