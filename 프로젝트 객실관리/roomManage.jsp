...
<html lang="en">
    ...
    <body id="page-top">
      ...
      <input type = "hidden" id="optypeoptype" name="optype">
...
<script language="javascript">
    ...
    .on('click','#update',function(){ 
       	if($('#optype').val('RoomSubmit')){
       		$.get('RoomSubmit'),{roomid:$('#roomid').val(),roomname:$('#roomname').val(),roomitem2$('#roomitem2').val(),roomexpense:$('#roomexpense'),person:$('#person').val()};
       	 function(txt){
       		 alert(txt);
       		 var r1 = $('#roomname').val();
